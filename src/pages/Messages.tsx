  ...
  const [mailList, setMailList] = useState([
    {
        id: 1,
        path: '',
        firstName: 'Misk Representative',
        lastName: '',
        email: 'miskksa@gmail.com',
        date: new Date(),
        time: '10:15 AM',
        title: 'Upcoming Exhibition Invitation',
        displayDescription: 'Join us for our upcoming art exhibition.',
        type: 'inbox',
        isImportant: false,
        isStar: false,
        isUnread: true,
        attachments: [],
        description: `
          <p class="mail-content">You are cordially invited to participate in the upcoming art exhibition. Please let us know if you're interested.</p>
        `,
      },
      // {
      //     id: 2,
...
//   };
    ...
    const setGroup = (group: string) => { 
        if (ids.length) {
            let items = mailList.filter((d: MailItem) => ids.includes(d.id));
            for (let item of items) {
                (item as any).group = group;  // ✅ Type assertion to avoid TypeScript error
            }

            showMessage(`${ids.length} Mail(s) have been grouped as ${group.toUpperCase()}`);
            clearSelection();
            setTimeout(() => {
                searchMails(false);
            });
  ...
  const searchMails = (isResetPage = true) => {
      ...
      if (selectedTab === 'important') {
        ...
        res = mailList.filter((d) => (d as any).group === selectedTab);
      } else {
          ...
          <div className="flex gap-5 relative sm:h-[calc(100vh_-_150px)] h-full">
              ...
              >
                  <div className="flex flex-col h-full pb-16">
                      <div className="pb-5">
                          <button className="btn bg-yankees-blue font-montserrat-light text-white w-full" type="button" onClick={() => openMail('add', null)}>
                              New Message
                          </button>
                      </div>
                          ...
                          <div className="space-y-1">
                              ...
                              >
                                  <div className="flex items-center">
                                      ...
                                      <div className="ltr:ml-3 rtl:mr-3 text-yankees-blue font-montserrat-light">Inbox</div>
                                  </div>
                                  <div className="bg-primary-light dark:bg-[#060818] rounded-md py-0.5 px-2 font-montserrat-light whitespace-nowrap">
                              ...
                              >
                                  <div className="flex items-center">
                                      ...
                                      <div className="ltr:ml-3 rtl:mr-3 text-yankees-blue font-montserrat-light">Marked</div>
                                  </div>
                              </button>
                              ...
                              >
                                  <div className="flex items-center">
                                      ...
                                      <div className="ltr:ml-3 rtl:mr-3 text-yankees-blue font-montserrat-light">Sent</div>
                                  </div>
                              </button>
                              ...
                              >
                                  <div className="flex items-center">
                                      ...
                                      <div className="ltr:ml-3 rtl:mr-3 text-yankees-blue font-montserrat-light">Spam</div>
                                  </div>
                              </button>
                              ...
                              >
                                  <div className="flex items-center">
                                      ...
                                      <div className="ltr:ml-3 rtl:mr-3 text-yankees-blue font-montserrat-light">Drafts</div>
                                  </div>
                                  <div className="bg-primary-light dark:bg-[#060818] font-montserrat-light text-yankees-blue rounded-md py-0.5 px-2  whitespace-nowrap">
                              ...
                              >
                                  <div className="flex items-center">
                                      ...
                                      <div className="ltr:ml-3 rtl:mr-3 text-yankees-blue font-montserrat-light">Trash</div>
                                  </div>
                              </button>
                                          ...
                                          <Disclosure.Panel as="ul" unmount={false} className="mt-1 space-y-1">
                                              <li>
                                                  ...
                                                  >
                                                      ...
                                                      <div className="ltr:ml-3 rtl:mr-3 text-yankees-blue font-montserrat-light">Archive</div>
                                                  </button>
                                              </li>
                                              <li>
                                                  <button
                                                  ...
                                                  >
                                                      ...
                                                      <div className="ltr:ml-3 rtl:mr-3 text-yankees-blue font-montserrat-light">Important</div>
                                                  </button>
                                              </li>
                                          </Disclosure.Panel>
                                      </>
                      ...
                      <div className="flex flex-col h-full">
                                              ...
                                              <div className="dropdown">
                                                  ...
                                                  >
                                                      <ul className="whitespace-nowrap">
                                                          <li>
                                                              <button className='text-yankees-blue font-montserrat-light' type="button" onClick={() => setAction('read')}>
                                                                  <IconOpenBook className="ltr:mr-2 rtl:ml-2 shrink-0" />
                                                                  Mark as Read
                                                              </button>
                                                          </li>
                                                          <li>
                                                              <button className='text-yankees-blue font-montserrat-light' type="button" onClick={() => setAction('unread')}>
                                                                  <IconBook className="ltr:mr-2 rtl:ml-2 shrink-0" />
                                                                  Mark as Unread
                                                              </button>
                                                          </li>
                                                          <li>
                                                              <button className='text-yankees-blue font-montserrat-light' type="button" onClick={() => setAction('trash')}>
                              ...
                              <div className="flex justify-between items-center sm:w-auto w-full">
                                  <div className="flex items-center ltr:mr-4 rtl:ml-4">
                                      ...
                                      <div className="relative group">
                                          <input
                                              type="text"
                                              className="form-input ltr:pr-8 rtl:pl-8 peer font-montserrat-thin"
                                  ...
                                  <div className="ml-4 md:flex-auto flex-1">
                                  <div className="flex items-center md:justify-end justify-center">
                                      ...
                                      <button
                                          ...
                                          className="bg-[#f4f4f4] rounded-md p-1 text-yankees-blue enabled:hover:bg-primary-light dark:bg-white-dark/20 enabled:dark:hover:bg-white-dark/30 disabled:opacity-60 disabled:cursor-not-allowed"
                                          onClick={() => {
                                              pager.currentPage++;
                                              searchMails(false);
                                          }}
                          ...
                          <div className="flex flex-wrap flex-col md:flex-row xl:w-auto justify-between items-center px-4 pb-4">
                              <div className="w-full sm:w-auto grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4">
                                  <button
                                      type="button"
                                      className={`btn font-montserrat-light text-nowrap border-palatinate-purple text-palatinate-purple shadow-none hover:bg-palatinate-purple hover:text-white flex ${selectedTab === 'personal' ? 'text-black bg-palatinate-purple' : ''}`}
                                      onClick={() => {
                                  ...
                                  <button
                                      type="button"
                                      className={`btn font-montserrat-light  border-fire-opal text-fire-opal shadow-none hover:bg-fire-opal hover:text-white flex ${selectedTab === 'work' ? 'text-white bg-fire-opal' : ''}`}
                                      onClick={() => {
                                          setSelectedTab('work');
                                          tabChanged('work');
                                      }}
                                  ...
                                  <button
                                      type="button"
                                      className={`btn font-montserrat-light  border-yellow-munsell text-yellow-munsell shadow-none hover:bg-yellow-munsell hover:text-white flex ${selectedTab === 'social' ? 'text-white bg-yellow-munsell' : ''}`}
                                      onClick={() => {
                                  ...
                                  <button
                                      type="button"
                                      className={`btn font-montserrat-light  border-madder-lake text-madder-lake shadow-none hover:bg-madder-lake hover:text-white flex ${selectedTab === 'private' ? 'text-white bg-madder-lake' : ''}`}
                                      onClick={() => {
                          ...
                          {pagedMails.length ? (
                                          ...
                                          {pagedMails.map((mail: any) => {
                                              return (
                                                  <tr key={mail.id} className="cursor-pointer" onClick={() => selectMail(mail)}>
                                                          ...
                                                          <div className="flex items-center whitespace-nowrap">
                                                              ...
                                                              <div className="ltr:mr-3 rtl:ml-3">
                                                                  <Tippy content="Star">
                                                                      <button
                                                                          type="button"
                                                                          className={`enabled:hover:text-yellow-munsell disabled:opacity-60 flex items-center ${mail.isStar ? 'text-yellow-munsell' : ''}`}
                                                                          onClick={(e) => {
                                                                              e.stopPropagation();
                                                                              setStar(mail.id);
                                                                          }}
                                                                      ...
                                                                      >
                                                                          <IconStar className={mail.isStar ? 'fill-yellow-munsell' : ''} />
                                                                      </button>
                                                                  </Tippy>
                                                              </div>
                                                              <div className="ltr:mr-3 rtl:ml-3">
                                                                  <Tippy content="Important">
                                                                      <button
                                                                          type="button"
                                                                          className={`enabled:hover:text-yankees-blue disabled:opacity-60 rotate-90 flex items-center ${
                                                                              mail.isImportant ? 'text-yankees-blue' : ''
                                                                          }`}
                                                                          onClick={(e) => {
                                                                              e.stopPropagation();
                                                                          ...
                                                                          disabled={selectedTab === 'trash'}
                                                                      >
                                                                          <IconBookmark bookmark={false} className={`w-4.5 h-4.5 ${mail.isImportant && 'fill-yankees-blue'}`} />
                                                                      </button>
                                                                  </Tippy>
                                                              </div>
                                                              <div
                                                                  className={`dark:text-gray-300 whitespace-nowrap font-montserrat-regular ${
                                                                      !mail.isUnread ? 'text-gray-500 dark:text-gray-500 font-montserrat-regular' : ''
                                                                  }`}
                                                              >
                                                      ...
                                                      <td>
                                                          <div className="font-montserrat-light text-white-dark overflow-hidden min-w-[300px] line-clamp-1">
                                                              <span className={`${mail.isUnread ? 'text-yankees-blue dark:text-gray-300 font-montserrat-regular' : ''}`}>
                                                          ...
                                                          <div className="flex items-center">
                                                              <div
                                                                  className={`w-2 h-2 rounded-full ${
                                                                      (mail.group === 'personal' && 'bg-yankees-blue') ||
                                                                      (mail.group === 'work' && 'bg-yellow-munsell') ||
                                                                      (mail.group === 'social' && 'bg-fire-opal') ||
                                                                      (mail.group === 'private' && 'bg-madder-lake')
                                                                  }`}
                                                              ></div>
                                                              {mail.attachments && (
                                                                  <div className="ltr:ml-4 rtl:mr-4 text-yankees-blue" >
                                                                      <IconPaperclip />
                                                                  </div>
                                                              )}
                                                          </div>
                                                      </td>
                                                      <td className="whitespace-nowrap font-montserrat-regular text-yankees-blue ltr:text-right rtl:text-left">{showTime(mail)}</td>
                                                  </tr>
                                              );
                                          })}
                                      </tbody>
                              ...
                              <div className="grid place-content-center min-h-[300px] font-montserrat-light text-yankees-blue text-lg h-full">No data available</div>
                          )}
                      </div>
                  )}
                  ...
                  {selectedMail && !isEdit && (
                      <div>
                          <div className="flex items-center justify-between flex-wrap p-4">
                              <div className="flex items-center">
                                  <button type="button" className="ltr:mr-2 rtl:ml-2 hover:text-yankees-blue" onClick={() => setSelectedMail(null)}>
                                      <IconArrowLeft className="w-5 h-5 rotate-180" />
                                  </button>
                                  <h4 className="text-base text-yankees-blue font-montserrat-regular md:text-lg  ltr:mr-2 rtl:ml-2">{selectedMail.title}</h4>
                                  <div className="badge bg-yellow-munsell hover:top-0">{selectedMail.type}</div>
                              </div>
                              <div>
                                  <Tippy content="Print">
                                      <button type="button">
                          ...
                          <div className="p-4 relative">
                              <div className="flex flex-wrap">
                                  ...
                                  <div className="ltr:mr-2 rtl:ml-2 flex-1">
                                      <div className="flex items-center">
                                          <div className="text-lg text-yankees-blue font-montserrat-regular ltr:mr-4 rtl:ml-4 whitespace-nowrap">
                                          ...
                                          {selectedMail.group && (
                                              <div className="ltr:mr-4 rtl:ml-4">
                                                  <Tippy content={selectedMail.group} className="capitalize">
                                                      <div
                                                          className={`w-2 h-2 rounded-full ${
                                                              (selectedMail.group === 'personal' && 'bg-yankees-blue') ||
                                                              (selectedMail.group === 'work' && 'bg-yellow-munsell') ||
                                                              (selectedMail.group === 'social' && 'bg-fire-opal') ||
                                                              (selectedMail.group === 'private' && 'bg-madder-lake')
                                                          }`}
                                                      ></div>
                                                  </Tippy>
                                              </div>
                                          )}
                                          <div className="text-white-dark font-montserrat-light whitespace-nowrap">1 days ago</div>
                                      </div>
                                      <div className="text-white-dark flex items-center">
                                          <div className="ltr:mr-1 rtl:ml-1 font-montserrat-light text-xs">{selectedMail.type === 'sent_mail' ? selectedMail.email : 'to me'}</div>
                                          <div className="dropdown">
                                              <Dropdown
                                                  offset={[0, 5]}
                                                  placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`}
                                                  ...
                                                  <ul className="sm:w-56">
                                                      <li>
                                                          <div className="flex items-center px-4 py-2">
                                                              <div className="text-white-dark ltr:mr-2 rtl:ml-2 w-1/4 font-montserrat-light">From:</div>
                                                              <div className="flex-1 font-montserrat-light text-yankees-blue">{selectedMail.type === 'sent_mail' ? 'qandeel1@gmail.com' : selectedMail.email}</div>
                                                          </div>
                                                      </li>
                                                      <li>
                                                          <div className="flex items-center px-4 py-2">
                                                              <div className="text-white-dark ltr:mr-2 rtl:ml-2 w-1/4 font-montserrat-light">To:</div>
                                                              <div className="flex-1 font-montserrat-light text-yankees-blue">{selectedMail.type !== 'sent_mail' ? 'qandeel1@gmail.com' : selectedMail.email}</div>
                                                          </div>
                                                      </li>
                                                      <li>
                                                          <div className="flex items-center px-4 py-2">
                                                              <div className="text-white-dark ltr:mr-2 rtl:ml-2 w-1/4 font-montserrat-light">Date:</div>
                                                              <div className="flex-1 font-montserrat-light text-yankees-blue">{selectedMail.date + ', ' + selectedMail.time}</div>
                                                          </div>
                                                      </li>
                                                      <li>
                                                          <div className="flex items-center px-4 py-2">
                                                              <div className="text-white-dark ltr:mr-2 rtl:ml-2 w-1/4 font-montserrat-light">Subject:</div>
                                                              <div className="flex-1 font-montserrat-light text-yankees-blue">{selectedMail.title}</div>
                                                          </div>
                                                      </li>
                                                  </ul>
                                              </Dropdown>
                                  ...
                                  <div>
                                      <div className="flex items-center justify-center space-x-3 rtl:space-x-reverse">
                                          <Tippy content="Star">
                                              <button
                                                  type="button"
                                                  className={`enabled:hover:text-yellow-munsell disabled:opacity-60 ${selectedMail.isStar ? 'text-yellow-munsell' : ''}`}
                                                  onClick={() => setStar(selectedMail.id)}
                                                  disabled={selectedTab === 'trash'}
                                              >
                                                  <IconStar className={selectedMail.isStar ? 'fill-yellow-munsell' : ''} />
                                              </button>
                                          </Tippy>
                                          <Tippy content="Important">
                                              <button
                                                  type="button"
                                                  className={`enabled:hover:text-yankees-blue disabled:opacity-60 ${selectedMail.isImportant ? 'text-yankees-blue' : ''}`}
                                                  onClick={() => setImportant(selectedMail.id)}
                                                  disabled={selectedTab === 'trash'}
                                              >
                                                  <IconBookmark bookmark={false} className={`w-4.5 h-4.5 rotate-90 ${selectedMail.isImportant && 'fill-yankees-blue'}`} />
                                              </button>
                                          </Tippy>
                                          <Tippy content="Reply">
                                              <button type="button" className="hover:text-yankees-blue" onClick={() => openMail('reply', selectedMail)}>
                                                  <IconArrowBackward className="rtl:hidden" />
                                                  <IconArrowForward className="ltr:hidden" />
                                              </button>
                                          </Tippy>
                                          <Tippy content="Forward">
                                              <button type="button" className="hover:text-yankees-blue" onClick={() => openMail('forward', selectedMail)}>
                              ...
                              <div
                                  className="mt-8 prose text-yankees-blue font-montserrat-light dark:prose-p:text-white prose-p:text-sm md:prose-p:text-sm max-w-full prose-img:inline-block prose-img:m-0"
                                  dangerouslySetInnerHTML={{ __html: selectedMail.description }}
                              ></div>
                              <p className="mt-4 font-montserrat-light text-yankees-blue">Best Regards,</p>
                              <p className="mt-4 font-montserrat-light text-yankees-blue">{selectedMail.firstName + ' ' + selectedMail.lastName}
                              </p>

                              {selectedMail.attachments && (
                                  <div className="mt-8">
                                      <div className="text-base mb-4 font-montserrat-regular text-yankees-blue">Attachments</div>
                                      <div className="h-px border-b border-white-light dark:border-[#1b2e4b]"></div>
                                          ...
                                          {selectedMail.attachments.map((attachment: any, i: number) => {
                                              return (
                                                  <button
                                                      key={i}
                                                      type="button"
                                                      className="flex items-center ltr:mr-4 rtl:ml-4 mb-4 border border-white-light dark:border-[#1b2e4b] rounded-md hover:text-yankees-blue hover:border-yankees-blue transition-all duration-300 px-4 py-2.5 relative group"
                                                  >
                                                      ...
                                                      <div className="ltr:ml-3 rtl:mr-3">
                                                          <p className="text-xs text-yankees-blue font-montserrat-light">{attachment.name}</p>
                                                          <p className="text-[11px] text-yankees-blue font-montserrat-light dark:text-gray-600">{attachment.size}</p>
                                                      </div>
                  ...
                  {isEdit && (
                      <div className="relative">
                          <div className="py-4 px-6 flex items-center">
                              <button type="button" className="xl:hidden hover:text-yankes-blue block ltr:mr-3 rtl:ml-3" onClick={() => setIsShowMailMenu(!isShowMailMenu)}>
                                  <IconMenu />
                              </button>
                              <h4 className="text-lg text-yankees-blue dark:text-gray-400 font-montserrat-regular">Message</h4>
                          </div>
                          ...
                          <form className="p-6 grid gap-6">
                              <div>
                                  <input
                                      id="to"
                                      type="text"
                                      className="form-input font-montserrat-extralight text-yankees-blue"
                              ...
                              <div>
                                  <input id="cc" type="text" className="form-input font-montserrat-extralight text-yankees-blue" placeholder="Enter Cc" defaultValue={params.cc} onChange={(e) => changeValue(e)} />
                              </div>

                              <div>
                                  <input id="title" type="text" className="form-input font-montserrat-extralight text-yankees-blue" placeholder="Enter Subject" defaultValue={params.title} onChange={(e) => changeValue(e)} />
                              </div>

                              <div className="h-fit font-montserrat-extralight text-yankees-blue">
                                  <ReactQuill
                                      theme="snow"
                              ...
                              <div>
                                  <input
                                      type="file"
                                      className="font-montserrat-extralight form-input file:py-2 file:px-4 file:border-0 file:font-semibold p-0 file:bg-yankees-blue ltr:file:mr-5 rtl:file:ml-5 file:text-white file:hover:bg-yankees-blue"
                                      multiple
                              ...
                              <div className="flex items-center ltr:ml-auto rtl:mr-auto mt-8">
                                  <button type="button" className="btn border-madder-lake text-madder-lake shadow-none hover:bg-madder-lake hover:text-white ltr:mr-3 rtl:ml-3" onClick={closeMsgPopUp}>
                                      Close
                                  </button>
                                  <button type="button" className="btn border-royal-orange text-royal-orange shadow-none hover:bg-royal-orange hover:text-white ltr:mr-3 rtl:ml-3" onClick={() => saveMail('save', null)}>
                                      Save as Draft
                                  </button>
                                  <button type="button" className="btn  border-yankees-blue bg-yankees-blue text-white shadow-yankees-blue" onClick={() => saveMail('send', params.id)}>
                                      Send
                                  </button>
                              </div>
                          </form>
